...
from sklearn.model_selection import train_test_split # Оновлено
...
plt.figure()
plt.scatter(class_0[:, 0], class_0[:, 1], s=75, facecolors='black', edgecolors='black', linewidth=1, marker='x', label='Class 0')
...
if len(sys.argv) > 1:
    if sys.argv[1] == 'balance':
        ...
        print("Режим: З балансуванням")
    else:
        print("Режим: Без балансування")
else:
    print("Режим: Без балансування (додайте аргумент 'balance' для включення)")
